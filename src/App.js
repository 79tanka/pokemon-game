...
const App= () =>{
  return(
    <>
      <HeaderBlock 
      title="It is title of header" 
      descr="It is description of header" 
      />
      <LayoutBlock 
      title="Rules" 
      descr="It is description of 1 layout"  
      urlBg={bg1} >
        <p>
      ...
      <LayoutBlock 
      title="Cards" 
      descr="It is description of 2 layout -Cards"   
      colorBg='blue' >
      ...
      <LayoutBlock 
      title="It is title of 3 layout" 
      descr="It is description of 3 layout"  
      urlBg={bg3} />
